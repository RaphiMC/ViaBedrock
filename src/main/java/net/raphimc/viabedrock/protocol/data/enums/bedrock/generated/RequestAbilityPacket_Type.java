...
public enum RequestAbilityPacket_Type {
    ...
    public static RequestAbilityPacket_Type getByName(final String name) {
        for (RequestAbilityPacket_Type value : values()) {
    ...
    public static RequestAbilityPacket_Type getByName(final String name, final RequestAbilityPacket_Type fallback) {
        for (RequestAbilityPacket_Type value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
