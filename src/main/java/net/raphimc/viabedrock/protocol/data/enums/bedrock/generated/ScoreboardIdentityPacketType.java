...
public enum ScoreboardIdentityPacketType {
    ...
    public static ScoreboardIdentityPacketType getByName(final String name) {
        for (ScoreboardIdentityPacketType value : values()) {
    ...
    public static ScoreboardIdentityPacketType getByName(final String name, final ScoreboardIdentityPacketType fallback) {
        for (ScoreboardIdentityPacketType value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
