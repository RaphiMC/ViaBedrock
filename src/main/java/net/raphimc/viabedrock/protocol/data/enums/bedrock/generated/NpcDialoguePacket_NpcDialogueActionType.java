...
public enum NpcDialoguePacket_NpcDialogueActionType {
    ...
    public static NpcDialoguePacket_NpcDialogueActionType getByName(final String name) {
        for (NpcDialoguePacket_NpcDialogueActionType value : values()) {
    ...
    public static NpcDialoguePacket_NpcDialogueActionType getByName(final String name, final NpcDialoguePacket_NpcDialogueActionType fallback) {
        for (NpcDialoguePacket_NpcDialogueActionType value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
