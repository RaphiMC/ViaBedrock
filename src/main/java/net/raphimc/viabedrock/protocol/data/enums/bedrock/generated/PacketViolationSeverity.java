...
public enum PacketViolationSeverity {
    ...
    public static PacketViolationSeverity getByName(final String name) {
        for (PacketViolationSeverity value : values()) {
    ...
    public static PacketViolationSeverity getByName(final String name, final PacketViolationSeverity fallback) {
        for (PacketViolationSeverity value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
