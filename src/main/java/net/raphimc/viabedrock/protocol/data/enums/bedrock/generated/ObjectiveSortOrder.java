...
public enum ObjectiveSortOrder {
    ...
    public static ObjectiveSortOrder getByName(final String name) {
        for (ObjectiveSortOrder value : values()) {
    ...
    public static ObjectiveSortOrder getByName(final String name, final ObjectiveSortOrder fallback) {
        for (ObjectiveSortOrder value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
