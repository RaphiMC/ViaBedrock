...
public enum ActorDataBoundingBoxComponent_Type {
    ...
    public static ActorDataBoundingBoxComponent_Type getByName(final String name) {
        for (ActorDataBoundingBoxComponent_Type value : values()) {
    ...
    public static ActorDataBoundingBoxComponent_Type getByName(final String name, final ActorDataBoundingBoxComponent_Type fallback) {
        for (ActorDataBoundingBoxComponent_Type value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
