...
public enum MapItemTrackedActor_Type {
    ...
    public static MapItemTrackedActor_Type getByName(final String name) {
        for (MapItemTrackedActor_Type value : values()) {
    ...
    public static MapItemTrackedActor_Type getByName(final String name, final MapItemTrackedActor_Type fallback) {
        for (MapItemTrackedActor_Type value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
