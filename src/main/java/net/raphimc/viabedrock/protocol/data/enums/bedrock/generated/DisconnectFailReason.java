...
public enum DisconnectFailReason {
    ...
    private static final Int2ObjectMap<DisconnectFailReason> BY_VALUE = new Int2ObjectOpenHashMap<>();

    static {
        for (DisconnectFailReason value : values()) {
    ...
    public static DisconnectFailReason getByValue(final int value) {
        return BY_VALUE.get(value);
    }

    public static DisconnectFailReason getByValue(final int value, final DisconnectFailReason fallback) {
        return BY_VALUE.getOrDefault(value, fallback);
    }

    public static DisconnectFailReason getByName(final String name) {
        for (DisconnectFailReason value : values()) {
    ...
    public static DisconnectFailReason getByName(final String name, final DisconnectFailReason fallback) {
        for (DisconnectFailReason value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
    ...
    DisconnectFailReason(final DisconnectFailReason value) {
        this(value.value);
    }

    DisconnectFailReason(final int value) {
        this.value = value;
    }
