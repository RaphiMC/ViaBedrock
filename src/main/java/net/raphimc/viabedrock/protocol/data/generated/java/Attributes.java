...
public class Attributes {
    ...
    public static final String EXPLOSION_KNOCKBACK_RESISTANCE = "minecraft:explosion_knockback_resistance";
    ...
    public static final String MAX_ABSORPTION = "minecraft:max_absorption";
    ...
    public static final String SNEAKING_SPEED = "minecraft:sneaking_speed";
    public static final String SPAWN_REINFORCEMENTS = "minecraft:spawn_reinforcements";
    public static final String STEP_HEIGHT = "minecraft:step_height";
    public static final String SUBMERGED_MINING_SPEED = "minecraft:submerged_mining_speed";
    public static final String SWEEPING_DAMAGE_RATIO = "minecraft:sweeping_damage_ratio";
    public static final String TEMPT_RANGE = "minecraft:tempt_range";
    public static final String WATER_MOVEMENT_EFFICIENCY = "minecraft:water_movement_efficiency";
    public static final String WAYPOINT_RECEIVE_RANGE = "minecraft:waypoint_receive_range";
    public static final String WAYPOINT_TRANSMIT_RANGE = "minecraft:waypoint_transmit_range";
