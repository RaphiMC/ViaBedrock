...
public enum MovementEffectType {
    ...
    public static MovementEffectType getByName(final String name) {
        for (MovementEffectType value : values()) {
    ...
    public static MovementEffectType getByName(final String name, final MovementEffectType fallback) {
        for (MovementEffectType value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
