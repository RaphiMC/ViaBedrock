...
public enum CameraAimAssistPacketPayload_TargetMode {
    ...
    public static CameraAimAssistPacketPayload_TargetMode getByName(final String name) {
        for (CameraAimAssistPacketPayload_TargetMode value : values()) {
    ...
    public static CameraAimAssistPacketPayload_TargetMode getByName(final String name, final CameraAimAssistPacketPayload_TargetMode fallback) {
        for (CameraAimAssistPacketPayload_TargetMode value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
