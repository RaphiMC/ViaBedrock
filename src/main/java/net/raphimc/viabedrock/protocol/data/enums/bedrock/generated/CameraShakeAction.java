...
public enum CameraShakeAction {
    ...
    public static CameraShakeAction getByName(final String name) {
        for (CameraShakeAction value : values()) {
    ...
    public static CameraShakeAction getByName(final String name, final CameraShakeAction fallback) {
        for (CameraShakeAction value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
