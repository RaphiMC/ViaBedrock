...
public enum SimpleEventPacket_Subtype {
    ...
    public static SimpleEventPacket_Subtype getByName(final String name) {
        for (SimpleEventPacket_Subtype value : values()) {
    ...
    public static SimpleEventPacket_Subtype getByName(final String name, final SimpleEventPacket_Subtype fallback) {
        for (SimpleEventPacket_Subtype value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
