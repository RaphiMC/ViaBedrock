...
public enum ActorDataIDs {
    ...
    AIR_SUPPLY(7),
    EFFECT_COLOR(8),
    RESERVED_009(9), // EFFECT_AMBIENCE (Deprecated)
    RESERVED_010(10), // JUMP_DURATION
    HURT(11), // HURT_TICKS
    HURT_DIR(12),
    ROW_TIME_LEFT(13),
    ROW_TIME_RIGHT(14),
    VALUE(15),
    DISPLAY_TILE_RUNTIME_ID(16), // Used for multiple things (#blameMojang)
    DISPLAY_OFFSET(17), // ALSO ARROW_SHOOTER_ID / FIREWORK_DIRECTION ????
    CUSTOM_DISPLAY(18), // ALSO FIREWORK_SHOOTER_ID ???
    SWELL(19), // HORSE_TYPE ?
    OLD_SWELL(20),
    SWELL_DIR(21),
    CHARGE_AMOUNT(22),
    ...
    PLAYER_INDEX(27),
    BED_POSITION(28),
    X_POWER(29), // FIREBALL_POWER_X
    Y_POWER(30), // FIREBALL_POWER_Y
    Z_POWER(31), // FIREBALL_POWER_Z
    AUX_POWER(32), // Potion aux value used for an Arrow's trail. (Equal to the potion ID - 1)
    FISHX(33),
    FISHZ(34),
    FISHANGLE(35),
    AUX_VALUE_DATA(36),
    LEASH_HOLDER(37), // Unique ID for the entity who holds a leash to the current entity.
    RESERVED_038(38), // SCALE
    HAS_NPC(39),
    NPC_DATA(40),
    ACTIONS(41),
    AIR_SUPPLY_MAX(42),
    ...
    BLOCK_TARGET(47), // Target position of Ender Crystal beam.
    INV(48),
    TARGET_A(49),
    TARGET_B(50),
    TARGET_C(51),
    AERIAL_ATTACK(52),
    RESERVED_053(53), // WIDTH
    RESERVED_054(54), // HEIGHT
    FUSE_TIME(55),
    RESERVED_056(56), // SEAT_OFFSET
    ...
    ATTACHED(66),
    ATTACH_POS(67),
    TRADE_TARGET(68), // Sets the unique ID of the player that is trading with this entity.
    CAREER(69), // Previously used for the villager V1 entity. Deprecated
    HAS_COMMAND_BLOCK(70), // COMMAND_BLOCK_ENABLED
    COMMAND_NAME(71),
    LAST_COMMAND_OUTPUT(72),
    TRACK_COMMAND_OUTPUT(73),
    RESERVED_074(74), // CONTROLLING_RIDER_SEAT_INDEX
    STRENGTH(75),
    STRENGTH_MAX(76),
    DATA_SPELL_CASTING_COLOR(77),
    DATA_LIFETIME_TICKS(78),
    POSE_INDEX(79),
    DATA_TICK_OFFSET(80), // END_CRYSTAL_TICK_OFFSET (not possible on java)
    ...
    BALLOON_ANCHOR(85),
    PUFFED_STATE(86),
    BUBBLE_TIME(87), // BOAT_BUBBLE_TIME
    AGENT(88),
    SITTING_AMOUNT(89),
    SITTING_AMOUNT_PREVIOUS(90),
    EATING_COUNTER(91),
    RESERVED_092(92), // FLAGS_2 ?
    LAYING_AMOUNT(93),
    LAYING_AMOUNT_PREVIOUS(94),
    DATA_DURATION(95), // AREA_EFFECT_CLOUD_DURATION
    DATA_SPAWN_TIME_deprecated(96), // AREA_EFFECT_CLOUD_SPAWN_TIME
    DATA_CHANGE_RATE(97), // AREA_EFFECT_CLOUD_CHANGE_RATE
    DATA_CHANGE_ON_PICKUP(98), // AREA_EFFECT_CLOUD_CHANGE_ON_PICKUP
    DATA_PICKUP_COUNT(99), // AREA_EFFECT_CLOUD_PICKUP_COUNT
    INTERACT_TEXT(100),
    TRADE_TIER(101),
    MAX_TRADE_TIER(102),
    ...
    HITBOX(118), // Set custom hitboxes for an entity.
    IS_BUOYANT(119),
