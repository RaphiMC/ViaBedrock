...
public enum ModalFormCancelReason {
    ...
    public static ModalFormCancelReason getByName(final String name) {
        for (ModalFormCancelReason value : values()) {
    ...
    public static ModalFormCancelReason getByName(final String name, final ModalFormCancelReason fallback) {
        for (ModalFormCancelReason value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
