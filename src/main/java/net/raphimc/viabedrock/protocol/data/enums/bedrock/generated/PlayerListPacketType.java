...
public enum PlayerListPacketType {
    ...
    public static PlayerListPacketType getByName(final String name) {
        for (PlayerListPacketType value : values()) {
    ...
    public static PlayerListPacketType getByName(final String name, final PlayerListPacketType fallback) {
        for (PlayerListPacketType value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
