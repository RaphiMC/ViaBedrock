...
public enum PositionTrackingDBServerBroadcastPacket_Action {
    ...
    public static PositionTrackingDBServerBroadcastPacket_Action getByName(final String name) {
        for (PositionTrackingDBServerBroadcastPacket_Action value : values()) {
    ...
    public static PositionTrackingDBServerBroadcastPacket_Action getByName(final String name, final PositionTrackingDBServerBroadcastPacket_Action fallback) {
        for (PositionTrackingDBServerBroadcastPacket_Action value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
