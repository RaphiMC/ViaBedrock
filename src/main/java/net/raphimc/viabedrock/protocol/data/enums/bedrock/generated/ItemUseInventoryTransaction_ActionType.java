...
public enum ItemUseInventoryTransaction_ActionType {
    ...
    public static ItemUseInventoryTransaction_ActionType getByName(final String name) {
        for (ItemUseInventoryTransaction_ActionType value : values()) {
    ...
    public static ItemUseInventoryTransaction_ActionType getByName(final String name, final ItemUseInventoryTransaction_ActionType fallback) {
        for (ItemUseInventoryTransaction_ActionType value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
