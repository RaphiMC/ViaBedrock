...
public enum ShowCreditsPacketPayload_CreditsState {
    ...
    public static ShowCreditsPacketPayload_CreditsState getByName(final String name) {
        for (ShowCreditsPacketPayload_CreditsState value : values()) {
    ...
    public static ShowCreditsPacketPayload_CreditsState getByName(final String name, final ShowCreditsPacketPayload_CreditsState fallback) {
        for (ShowCreditsPacketPayload_CreditsState value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
