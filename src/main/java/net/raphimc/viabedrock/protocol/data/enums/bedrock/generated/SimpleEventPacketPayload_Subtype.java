...
public enum SimpleEventPacketPayload_Subtype {
    ...
    public static SimpleEventPacketPayload_Subtype getByName(final String name) {
        for (SimpleEventPacketPayload_Subtype value : values()) {
    ...
    public static SimpleEventPacketPayload_Subtype getByName(final String name, final SimpleEventPacketPayload_Subtype fallback) {
        for (SimpleEventPacketPayload_Subtype value : values()) {
            if (value.name().equalsIgnoreCase(name)) {
                return value;
            }
