...
public class WorldPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        protocol.registerClientbound(ClientboundBedrockPackets.SET_SPAWN_POSITION, ClientboundPackets1_20_2.SPAWN_POSITION, new PacketHandlers() {
            @Override
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.CHANGE_DIMENSION, ClientboundPackets1_20_2.RESPAWN, wrapper -> {
            final int dimensionId = wrapper.read(BedrockTypes.VAR_INT); // dimension
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.UPDATE_BLOCK, ClientboundPackets1_20_2.BLOCK_CHANGE, new PacketHandlers() {
            @Override
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.UPDATE_BLOCK_SYNCED, ClientboundPackets1_20_2.BLOCK_CHANGE, new PacketHandlers() {
            @Override
            protected void register() {
                map(BedrockTypes.BLOCK_POSITION, Type.POSITION1_14); // position
                handler(wrapper -> {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.UPDATE_SUB_CHUNK_BLOCKS, null, wrapper -> {
            ...
            for (Map.Entry<Position, List<BlockChangeRecord>> entry : blockChanges.entrySet()) {
                ...
                final PacketWrapper multiBlockChange = wrapper.create(ClientboundPackets1_20_2.MULTI_BLOCK_CHANGE);
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.BLOCK_ENTITY_DATA, ClientboundPackets1_20_2.BLOCK_ENTITY_DATA, new PacketHandlers() {
            @Override
            protected void register() {
                map(BedrockTypes.BLOCK_POSITION, Type.POSITION1_14); // position
                handler(wrapper -> {
                    ...
                    if (javaBlockEntity instanceof BlockEntityWithBlockState) {
                        ...
                        if (blockEntityWithBlockState.hasBlockState()) {
                            final PacketWrapper blockChange = PacketWrapper.create(ClientboundPackets1_20_2.BLOCK_CHANGE, wrapper.user());
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.NETWORK_CHUNK_PUBLISHER_UPDATE, ClientboundPackets1_20_2.UPDATE_VIEW_DISTANCE, wrapper -> {
            ...
            final PacketWrapper updateViewPosition = wrapper.create(ClientboundPackets1_20_2.UPDATE_VIEW_POSITION);
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.CHUNK_RADIUS_UPDATED, ClientboundPackets1_20_2.UPDATE_VIEW_DISTANCE, new PacketHandlers() {
            @Override
            public void register() {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.SET_TIME, ClientboundPackets1_20_2.TIME_UPDATE, new PacketHandlers() {
            @Override
            public void register() {
