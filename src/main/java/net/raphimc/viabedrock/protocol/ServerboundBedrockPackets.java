...
public enum ServerboundBedrockPackets implements ServerboundPacketType {
    ...
    CLIENTBOUND_MAP_ITEM_DATA(MinecraftPacketIds.MapData.getValue()),
    ...
    FILTER_TEXT(MinecraftPacketIds.FilterTextPacket.getValue()),
    CLIENTBOUND_DEBUG_RENDERER(MinecraftPacketIds.ClientBoundDebugRendererPacket.getValue()),
    ...
    PLAYER_TOGGLE_CRAFTER_SLOT_REQUEST(MinecraftPacketIds.PlayerToggleCrafterSlotRequestPacket.getValue()),
