...
public enum ServerboundBedrockPackets implements ServerboundPacketType {
    ...
    LEVEL_SOUND_EVENT_2(120),
    NETWORK_CHUNK_PUBLISHER_UPDATE(121),
    BIOME_DEFINITION_LIST(122),
    LEVEL_SOUND_EVENT(123),
    LECTERN_UPDATE(124),
    VIDEO_STREAM_CONNECT(125),
    MAP_CREATE_LOCKED_COPY(126),
    ON_SCREEN_TEXTURE_ANIMATION(127),
    ...
    EMOTE_LIST(152),
    POSITION_TRACKING_DBSERVER_BROADCAST(153),
    POSITION_TRACKING_DBCLIENT_REQUEST(154),
    DEBUG_INFO(155),
    VIOLATION_WARNING(156),
