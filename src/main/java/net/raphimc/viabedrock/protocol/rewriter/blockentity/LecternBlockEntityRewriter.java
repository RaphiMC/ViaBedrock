...
public class LecternBlockEntityRewriter implements BlockEntityRewriter.Rewriter {
    ...
    public BlockEntity toJava(UserConnection user, BedrockBlockEntity bedrockBlockEntity) {
        ...
        if (bedrockTag.get("book") instanceof CompoundTag) {
            javaTag.put("Book", rewriteSlot(user, bedrockTag.get("book")));
        }
        copy(bedrockTag, javaTag, "page", "Page", IntTag.class);

        final BlockEntity javaBlockEntity = new BlockEntityImpl(bedrockBlockEntity.packedXZ(), bedrockBlockEntity.y(), -1, javaTag);
        ...
        if (bedrockTag.get("hasBook") instanceof ByteTag && bedrockTag.<ByteTag>get("hasBook").asByte() != 0) {
            ...
            return new BlockEntityWithBlockState(javaBlockEntity, javaBlockState - 2);
        }
