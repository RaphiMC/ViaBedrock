...
public class NetworkItemStackDescriptorType extends Type<BedrockItem> {
    ...
    public NetworkItemStackDescriptorType(final int blockingId, final Int2ObjectMap<IntSortedSet> blockItemValidBlockStates, final boolean writeItemNetId) {
    ...
    public BedrockItem read(final ByteBuf buffer) {
        final short id = buffer.readShortLE();
    ...
    public void write(final ByteBuf buffer, final BedrockItem value) {
        buffer.writeShortLE(value.identifier());
