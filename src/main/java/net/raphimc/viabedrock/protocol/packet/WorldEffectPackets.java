...
public class WorldEffectPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        protocol.registerClientbound(ClientboundBedrockPackets.PLAY_SOUND, ClientboundPackets1_21_5.SOUND, wrapper -> {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.STOP_SOUND, ClientboundPackets1_21_5.STOP_SOUND, wrapper -> {
            final String name = wrapper.read(BedrockTypes.STRING); // sound name
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.SPAWN_PARTICLE_EFFECT, ClientboundPackets1_21_5.LEVEL_PARTICLES, wrapper -> {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.LEVEL_SOUND_EVENT, ClientboundPackets1_21_5.SOUND, wrapper -> {
            ...
            switch (soundEvent) {
                case RecordNull -> {
                    wrapper.setPacketType(ClientboundPackets1_21_5.STOP_SOUND);
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.LEVEL_EVENT, ClientboundPackets1_21_5.LEVEL_EVENT, wrapper -> {
            ...
            if ((rawLevelEvent & LevelEvent.ParticleLegacyEvent.getValue()) != 0 || rawLevelEvent == LevelEvent.ParticleGenericSpawn.getValue()) {
                wrapper.setPacketType(ClientboundPackets1_21_5.LEVEL_PARTICLES);
            ...
            switch (levelEvent) {
                ...
                default -> {
                    ...
                    if (levelEventMapping instanceof BedrockMappingData.JavaLevelEvent javaLevelEvent) {
                        ...
                        wrapper.setPacketType(ClientboundPackets1_21_5.SOUND);
                        wrapper.write(Types.SOUND_EVENT, Holder.of(javaSound.id())); // sound id
                        wrapper.write(Types.VAR_INT, javaSound.category().ordinal()); // category
                        wrapper.write(Types.INT, (int) (position.x() * 8F)); // x
                        wrapper.write(Types.INT, (int) (position.y() * 8F)); // y
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.LEVEL_EVENT_GENERIC, ClientboundPackets1_21_5.LEVEL_PARTICLES, wrapper -> {
            final int rawLevelEvent = wrapper.read(BedrockTypes.VAR_INT); // event id
            ...
            switch (levelEvent) {
                ...
                case SculkCatalystBloom -> {
                    ...
                    final PacketWrapper sound = PacketWrapper.create(ClientboundPackets1_21_5.SOUND, wrapper.user());
                ...
                case SculkCharge -> {
                    wrapper.setPacketType(ClientboundPackets1_21_5.LEVEL_EVENT);
