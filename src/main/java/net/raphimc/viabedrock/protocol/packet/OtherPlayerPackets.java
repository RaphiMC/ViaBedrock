...
public class OtherPlayerPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        protocol.registerClientbound(ClientboundBedrockPackets.ADD_PLAYER, ClientboundPackets1_21_6.ADD_ENTITY, wrapper -> {
            ...
            wrapper.write(Types.VAR_INT, EntityTypes1_21_6.PLAYER.getId()); // type id
            ...
            final PacketWrapper setEquipment = PacketWrapper.create(ClientboundPackets1_21_6.SET_EQUIPMENT, wrapper.user());
            ...
            setEquipment.write(VersionedTypes.V1_21_6.item, itemRewriter.javaItem(item)); // item
            setEquipment.send(BedrockProtocol.class);

            entity.updateEntityData(entityData);
        });
        protocol.registerClientbound(ClientboundBedrockPackets.MOVE_PLAYER, ClientboundPackets1_21_6.ENTITY_POSITION_SYNC, wrapper -> {
            final EntityTracker entityTracker = wrapper.user().get(EntityTracker.class);
            ...
            if (!entity.javaType().isOrHasParent(EntityTypes1_21_6.PLAYER)) {
            ...
            if (mode == PlayerPositionModeComponent_PositionMode.OnlyHeadRot) {
                ...
                wrapper.setPacketType(ClientboundPackets1_21_6.MOVE_ENTITY_ROT);
                wrapper.write(Types.VAR_INT, entity.javaId()); // entity id
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.UPDATE_ABILITIES, ClientboundPackets1_21_6.PLAYER_ABILITIES, wrapper -> {
            final EntityTracker entityTracker = wrapper.user().get(EntityTracker.class);
            final PlayerAbilities abilities = wrapper.read(BedrockTypes.PLAYER_ABILITIES); // abilities
