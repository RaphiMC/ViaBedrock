 ...
 * <p>
 * Note: Block breaking/placing, item use and entity metadata/mounting have been promoted to the stable protocol.
 * What remains experimental is the map item data rewriter and the experimental item data rewriter.
 */
