...
public class InventoryContainer extends Container {
    ...
    private void onSelectedHotbarSlotChanged(final BedrockItem oldItem, final BedrockItem newItem, final PacketWrapper mobEquipment) {
        ...
        mobEquipment.write(this.user.get(ItemRewriter.class).itemStackType(), newItem); // item
        mobEquipment.write(Types.UNSIGNED_BYTE, (short) this.selectedHotbarSlot); // slot
        mobEquipment.write(Types.UNSIGNED_BYTE, (short) this.selectedHotbarSlot); // selected slot
        mobEquipment.write(Types.UNSIGNED_BYTE, (short) this.containerId); // container id
    }
