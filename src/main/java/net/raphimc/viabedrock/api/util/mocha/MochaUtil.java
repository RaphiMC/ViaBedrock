...
public final class MochaUtil {
    ...
    public static SimpleMochaEngine<?> build(final ResourcePacksStorage storage, final BedrockEntityData bedrock, final EntityData[] entityData, final EnumSet<ActorFlags> flags) {
