...
public class BedrockSoundListGenerator {
    ...
    private static final Map<String, Puv_Legacy_LevelSoundEvent> SOUND_EVENT_MAP = Map.ofEntries(
            ...
            Map.entry("armor.repair_wolf", Puv_Legacy_LevelSoundEvent.WolfArmourRepair),
            Map.entry("armor.crack_wolf", Puv_Legacy_LevelSoundEvent.WolfArmourCrack),
            Map.entry("armor.break_wolf", Puv_Legacy_LevelSoundEvent.WolfArmourBreak),
